const IMAGES = {
    ...
    eliza : new URL ('../images/eliza.png', import.meta.url).href,
    farmer: new URL ('../images/farmer.png', import.meta.url).href,
    groupStar: new URL ('../images/groupStar.png', import.meta.url).href,
    tj: new URL ('../images/tj.png', import.meta.url).href,
